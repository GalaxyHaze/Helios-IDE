...
template <> constexpr inline auto ActivityBar::qt_create_metaobjectdata<qt_meta_tag_ZN11ActivityBarE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'modeChanged'
        QtMocHelpers::SignalData<void(ActivityBar::Mode)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void ActivityBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->modeChanged((*reinterpret_cast<std::add_pointer_t<ActivityBar::Mode>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ActivityBar::*)(ActivityBar::Mode )>(_a, &ActivityBar::modeChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void ActivityBar::modeChanged(ActivityBar::Mode _t1)
{
