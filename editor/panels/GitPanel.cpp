    ...
    : QWidget(parent)
{
    ...
    m_initButton->setStyleSheet("background: #a6d189; color: #11111b; font-weight: bold; padding: 6px;");
    layout->addWidget(m_initButton);
    
    m_connectGithubButton = new QPushButton("Connect to GitHub");
    m_connectGithubButton->setStyleSheet("background: #8caaee; color: #11111b; font-weight: bold; padding: 6px;");
